...
*consider giving more details here, with plots*      
__to myself: perhaps give this all with more details, and plots__

# Before we go to an exercise and fit a linear model in R     
<span style = 'color:orange'>*Repetition is the mother of all skill*</span>    
